...
function doCheckWH(flag){
	...
	var o_Preview = document.getElementById("tdPreview");
	if (flag==1){
		o_Preview.innerHTML="<span style='font-size:"+oForm.d_syfontsize.value+"px;font-family:"+oForm.d_syfontname.value+"'>"+oForm.d_sytext.value+"</span>";
		oForm.d_sywztextwidth.value=o_Preview.firstChild.offsetWidth;
		oForm.d_sywztextheight.value=o_Preview.firstChild.offsetHeight;
	}else{
		...
		if (url==""){
			...
			o_Preview.innerHTML="<img border=0 src='"+url+"' onload='setCheckWH(this)' onerror='ErrorCheckWH()'>";
		}
	}
}
...
function setCheckWH(obj){
	document.myform.d_sytpimagewidth.value=obj.offsetWidth;
	document.myform.d_sytpimageheight.value=obj.offsetHeight;
}
